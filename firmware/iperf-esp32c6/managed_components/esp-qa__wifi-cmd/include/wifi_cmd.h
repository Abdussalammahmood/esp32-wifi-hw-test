...
/**
 * @brief Register commands: ap_deauth
 */
...
/**
 * @brief Register commands: wifi_offchannel
 */
...
/**
 * @brief Register commands: sta_scan_parameters
 */
...
/**
 * @brief Register commands: sta_wake_time
 */
void wifi_cmd_register_sta_wake_time(void);
#endif /* WIFI_CMD_STA_WAKE_TIME_SUPPORTED */
...
wifi_second_chan_t wifi_cmd_sec_channel_str2val(const char *sec_channel);
