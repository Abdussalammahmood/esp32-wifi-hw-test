...
static const wifi_event_handler_entry_t s_wifi_event_handlers[] = {
    ...
    {WIFI_EVENT_ACTION_TX_STATUS, &wifi_cmd_handler_action_tx_status},
    {WIFI_EVENT_ROC_DONE, &wifi_cmd_handler_roc_done},
#endif
#if CONFIG_ESP_WIFI_SOFTAP_SUPPORT
    {WIFI_EVENT_AP_STADISCONNECTED, &wifi_cmd_handler_ap_stadisconnected},
    {WIFI_EVENT_AP_START, &wifi_cmd_handler_ap_start},
    {WIFI_EVENT_AP_STOP, &wifi_cmd_handler_ap_stop},
#endif
