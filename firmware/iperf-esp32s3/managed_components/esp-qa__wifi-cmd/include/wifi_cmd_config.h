...
/*
v5.2.5 commit id: 4b82ad6635bd46bade7d150ed953ce0aa9daab75
v5.3.3 commit id: 5145d66199350d347c29a6e5ae5f835663d74c36
v5.4.2 commit id: c497c899843b1d0698f448358f9404a27c52f09c
v5.5   commit id: 7b6a6531a4f8aebb61f43efbd9fdb2c8dc9b8753
*/
#if ((ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 2, 5) && ESP_IDF_VERSION < ESP_IDF_VERSION_VAL(5, 3, 0)) || \
    (ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 3, 3) && ESP_IDF_VERSION < ESP_IDF_VERSION_VAL(5, 4, 0)) || \
    (ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 4, 2))) && !CONFIG_ESP_WIFI_REMOTE_ENABLED && !CONFIG_ESP_HOST_WIFI_ENABLED
...
*/
#if (ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 1, 6) && ESP_IDF_VERSION < ESP_IDF_VERSION_VAL(5, 2, 0)) || \
...
#if ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 4, 2) /* IDF commit: 767273f2642830d7ef3ae69cd9597aa425c98c74*/
#define WIFI_CMD_OFFCHANNEL_SUPPORTED (1)
#endif

#if ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 3, 0) /* IDF commit: 770162d76cee65f8b2c1e4701d085f89acef20ef*/
#define WIFI_CMD_SCAN_PARAMETERS_SUPPORTED (1)
#endif

#if ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 2, 2) && !CONFIG_ESP_WIFI_REMOTE_ENABLED && !CONFIG_ESP_HOST_WIFI_ENABLED /* IDF commit: cd0ffdac129e773c66c70d5bede02864c788335a*/
#define WIFI_CMD_STA_WAKE_TIME_SUPPORTED (1)
#endif
