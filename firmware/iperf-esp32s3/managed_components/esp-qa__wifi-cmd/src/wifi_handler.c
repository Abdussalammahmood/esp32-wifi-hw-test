...
void wifi_cmd_default_handler_ap_start(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    ESP_LOGI(APP_TAG, "WIFI_EVENT_AP_START");
}

void wifi_cmd_default_handler_ap_stop(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
...
void wifi_cmd_default_handler_action_tx_status(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    wifi_event_action_tx_status_t *action_tx = (wifi_event_action_tx_status_t *) event_data;
    ESP_LOGI(APP_TAG, "WIFI_EVENT_ACTION_TX:STATUS:%d,IFX:%d,CHANNEL:%d,OP_ID:%d,CONTEXT:%" PRId32 "",
             action_tx->status, action_tx->ifx, action_tx->channel, action_tx->op_id, action_tx->context);
}

void wifi_cmd_default_handler_roc_done(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    wifi_event_roc_done_t *roc = (wifi_event_roc_done_t *) event_data;
    ESP_LOGI(APP_TAG, "WIFI_EVENT_ROC_DONE:STATUS:%d, OP_ID:%d, CHANNEL:%d,CONTEXT:%" PRId32 "",
             roc->status, roc->op_id, roc->channel);
}
#endif
...
__attribute__((weak)) void wifi_cmd_handler_ap_stop(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    return wifi_cmd_default_handler_ap_stop(arg, event_base, event_id, event_data);
}

__attribute__((weak)) void wifi_cmd_handler_ap_start(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    return wifi_cmd_default_handler_ap_start(arg, event_base, event_id, event_data);
}

#if WIFI_CMD_OFFCHANNEL_SUPPORTED
__attribute__((weak)) void wifi_cmd_handler_action_tx_status(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    return wifi_cmd_default_handler_action_tx_status(arg, event_base, event_id, event_data);
}
__attribute__((weak)) void wifi_cmd_handler_roc_done(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    return wifi_cmd_default_handler_roc_done(arg, event_base, event_id, event_data);
}
#endif
